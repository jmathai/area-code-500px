...
var client500Px = new Client500Px({
...
var getPhotoByCityName = function(cityName, jouleResponse) {
  var imageUrl = 'https://drscdn.500px.org/photo/6361557/m%3D1600_k%3D1_a%3D1/7cd606b858a17da669e55d57c4b3304a'
        ...
        request(
          ...
          , function (error, response, body) {
            if (!error && response.statusCode == 200) {
              ...
              getPhotoByCityName(cityName, jouleResponse);
            }
          }
        );
        break;
